            ...
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                <span>
                  ...
                  Embrace Innovation, Empower Collaboration, Ignite Change
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={14}
                    height={14}
                ...
                <h1>
                  Turning Visions into Reality: Unleashing Innovative Solutions
                  Across Industries{" "}
                </h1>
                <p>
                  Welcome to Sepnoty Technologies Pvt Ltd, where innovation
                  meets excellence. Our team specializes in transforming your
                  visions into tangible solutions that drive success. Explore
                  our services and embark on a journey of innovation with
                  Sepnoty.{" "}
                </p>
