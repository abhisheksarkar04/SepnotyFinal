          ...
          <div className="row">
            <div className="col-xxl-5 col-xl-4 d-flex flex-column gap-4 justify-content-between">
              <div className="section-title5 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                ...
                <h2>Meet the Minds Behind <span> Sepnoty's Creativity
                </span></h2>
                <p>Explore the creative minds shaping Sepnoty's innovative solutions. Get to know the team
                  driving our transformative vision and passion for excellence.</p>
              </div>
