          ...
          <div className="row">
            <div className="col-xxl-5 col-xl-4 d-flex flex-column gap-4 justify-content-between">
              ...
              >
                ...
                <h2>
                  Meet the Minds Behind <span> Sepnoty's Creativity</span>
                </h2>
                <p>
                  Explore the creative minds shaping Sepnoty's innovative
                  solutions. Get to know the team driving our transformative
            ...
            <div className="col-xxl-7 col-xl-8">
              <div className="row g-4">
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/mani.png" alt="" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/kavya.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/nithya.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/yamini.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/biswa.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
                ...
                >
                  <div className="team-card2">
                    <div className="team-img">
                      <img src="assets/img/home5/abhishek.png" alt="" />
                      <ul className="social-area">
                        <li>
                          <a href="https://www.facebook.com/">
                            <i className="bx bxl-facebook" />
