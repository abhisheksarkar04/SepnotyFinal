          ...
          <div className="row justify-content-center mb-60">
            <div className="col-lg-8">
              ...
              >
                ...
                <h2>Achieve Project Mastery
                </h2>
                <p>
                Step into Sepnoty, where digital innovation meets strategic excellence. We're your dynamic
partner in the world of digital marketing, dedicated to launching businesses into the spotlight
of online success
                </p>
              </div>
            </div>
                    ...
                    <div className="col-lg-6">
                      <div className="project-management-tab-content">
                        ...
                        >
                          ...
                          <p>
                            Elevate your marketing efforts with Sepnoty's expert guidance and support.
                          </p>
                          <ul>
                            <li>
                              <svg
                    ...
                    <div className="col-lg-6">
                      <div className="project-management-tab-content">
                        <div className="tab-content-top">
                          <h3>IT Teams</h3>
                          <p>
                            Empower your IT teams with Sepnoty's cutting-edge solutions and expertise.
                          </p>
                          <ul>
                            <li>
                              <svg
                    ...
                    <div className="col-lg-6">
                      <div className="project-management-tab-content">
                        <div className="tab-content-top">
                          ...
                          <p>
                            Streamline your operations and optimize efficiency with Sepnoty's comprehensive
                            solutions.
                    ...
                    <div className="col-lg-6">
                      <div className="project-management-tab-content">
                        <div className="tab-content-top">
                          ...
                          <p>
                            Drive project success with Sepnoty's proven methodologies and experienced project
                            managers.
                    ...
                    <div className="col-lg-6">
                      <div className="project-management-tab-content">
                        <div className="tab-content-top">
                          ...
                          <p>
                            Chart a course for long-term success with Sepnoty's strategic planning expertise.
                          </p>
                          <ul>
                            <li>
                              <svg
