                ...
                <div className="row g-lg-4 gy-5 align-items-center">
                  ...
                  >
                    <div className="service-details-top-content">
                      ...
                      <p>
                        At Sepnoty, we specialize in crafting cutting-edge web and
                        app solutions that not only meet but exceed expectations.
                        With our meticulous attention to detail and commitment to
                        excellence, we bring your digital vision to life, ensuring a
                        seamless user experience every step of the way.
                      </p>
                      ...
                      <div className="accordion" id="accordionTravel">
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingOne">
                            ...
                            >
                              01. What technologies do you specialize in for web and
                              app development?
                            </button>
                          </h2>
                          <div
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              including but not limited to HTML, CSS, JavaScript,
                              React, Angular, Vue.js, Node.js, Python, Django, Ruby
                              on Rails, and PHP.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingTwo">
                            ...
                            >
                              02. How do you ensure the security of web and app
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              including secure coding practices, regular security
                              audits, and implementation of security protocols such
                              as HTTPS and encryption.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingThree">
                            ...
                            >
                              03.What is your approach to user experience design in
                          ...
                          >
                            <div className="accordion-body">
                              We prioritize user-centric design, conducting thorough
                              user research and testing to ensure intuitive and
                              engaging user interfaces that meet the needs of the
                              target audience.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingFour">
                            ...
                            >
                              04. How do you ensure timely delivery of web and app
                              development projects?
                            </button>
                          </h2>
                          <div
                          ...
                          >
                            <div className="accordion-body">
                              We follow agile development methodologies, breaking
                              down projects into manageable sprints with clear
                              milestones and regular communication to ensure timely
                              delivery
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingFive">
                            ...
                            >
                              05. Do you provide ongoing support and maintenance for
                          ...
                          >
                            <div className="accordion-body">
                              ...
                              to keep your digital assets running smoothly,
                              including bug fixes, updates, and performance
                              optimizations.
                            </div>
                          </div>
                        </div>
