            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    Choose Sepnoty:{" "}
                    <span>Your Partner in Software Excellence.</span>
                  </h2>
                  <p>
                    Welcome to Sepnoty Technologies, where we specialize in
                    crafting innovative software solutions tailored to your
                    business needs. With our team of skilled developers and
                    designers, we deliver custom applications that drive growth
                    and success. From conceptualization to deployment, we're
                    here to bring your vision to life. Partner with us for your
                    next project and experience the Sepnoty difference.
                  </p>
                  ...
                  <div className="accordion" id="accordionTravel">
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          Sepnoty Technologies offers a wide range of services
                          including brand identity development, graphic design,
                          web design, digital marketing, content creation, and
                          video production. We provide comprehensive solutions
                          to help businesses establish their online presence,
                          engage with their audience, and achieve their
                          marketing goals.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingTwo">
                        ...
                        >
                          02. How does Sepnoty ensure the quality of its
                          services?
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div className="accordion-body">
                          At Sepnoty Technologies, we prioritize quality in
                          everything we do. Our team of experienced
                          professionals follows industry best practices, stays
                          updated on the latest trends and technologies, and
                          pays attention to detail to deliver exceptional
                          results. We also conduct thorough quality assurance
                          checks to ensure that our services meet our clients'
                          expectations.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingThree">
                        ...
                        >
                          03. Can Sepnoty Technologies accommodate specific
                      ...
                      >
                        <div className="accordion-body">
                          Yes, absolutely! We understand that every project is
                          unique, and we're committed to accommodating specific
                          requirements and preferences. Whether you need a
                          custom logo design, a tailored digital marketing
                          strategy, or a unique website layout, our team will
                          work closely with you to ensure that your project
                          meets your objectives and reflects your brand
                          identity.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingFour">
                        ...
                        >
                          04. How does Sepnoty Technologies handle client
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          projects at Sepnoty Technologies. We maintain open and
                          transparent communication channels with our clients
                          throughout the project lifecycle, providing regular
                          updates, seeking feedback, and addressing any
                          questions or concerns promptly. We also leverage
                          collaborative tools and platforms to facilitate
                          seamless collaboration and ensure that our clients are
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingFive">
                        ...
                        >
                          05. What sets Sepnoty Technologies apart from other
                          digital agencies?
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div className="accordion-body">
                          At Sepnoty Technologies, we differentiate ourselves
                          through our commitment to creativity, innovation, and
                          client satisfaction. We take a personalized approach
                          to every project, tailoring our solutions to meet our
                          clients' specific needs and goals. With our diverse
                          expertise, attention to detail, and dedication to
                          excellence, we strive to deliver exceptional value and
                          results for our clients, setting us apart as a trusted
